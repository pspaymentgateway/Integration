...
public class currency extends baseClass {
	...
	public void purchaseApi(String currency,String ExpectedStatus,String PSP) throws Exception {
		...
		if (response.statusCode() == 202) {
            ...
            ExcelWriteUtility.writeResults2s("s2s_Result", currency,ExpectedStatus, status, comment, purchaseId,PSP);
            driver.quit();
            return; 
        } else {
	...
	public void s2sMethod(String ExpectedStatus,String PSP) throws Exception {
        ...
        if (flag.equalsIgnoreCase("false")) {
            ...
            ExcelWriteUtility.writeResults2s("s2s_Result", currency,ExpectedStatus, actualOutcome, comment, purchaseId,PSP);
            driver.quit();
            return;
        }
