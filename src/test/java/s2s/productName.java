...
public class productName extends baseClass {
	...
	public void purchaseApi(Map<String, String> ProductName, Map<String, String> cardData) throws Exception {
		...
		String productName = ProductName.getOrDefault("TestData", "");
		String ExpectedStatus = ProductName.getOrDefault("Status", "");
		...
		if (response.statusCode() == 202) {
            ...
            ExcelWriteUtility.writeResults2s("s2s_Result", productName,ExpectedStatus, status, comment, purchaseId,PSP,PaymentMethod);
            driver.quit();
            return; 
        } else {
