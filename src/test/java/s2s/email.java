...
>>>>>>> Stashed changes
		...
		if (statusCode == 202) {
            ...
            Reporter.log("Email rejected by API: " + Email + " (Status: " + statusCode + ")", true);
            
            String actualOutcome = "FAIL";
            
            if (ExpectedStatus.equalsIgnoreCase("Fail")) {
                testResult = "PASS";
                comment = "Email rejected as expected";
            } else {
                testResult = "FAIL";
                comment = "Email rejected but expected to pass";
            }

            Reporter.log(comment, true);
            ExcelWriteUtility.writeResults2s("s2s_Result", Email, ExpectedStatus, actualOutcome, comment, "N/A", PSP,PaymentMethod);
            driver.quit();
            return;
            
        } else {
			Reporter.log("Unexpected response for email: " + Email + " -> Status: " + statusCode, true);
			testResult = "FAIL";
	...
	public void s2sMethod(String Email, String ExpectedStatus, String PSP, String CardNumber, String Expiry, String CVV,String PaymentMethod) throws Exception {
