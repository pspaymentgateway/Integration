...
public class email extends baseClass {
	...
	public void purchaseApi(String emailId,String ExpectedStatus,String PSP) throws Exception {
		...
		if (response.statusCode() == 202) {
            ...
            ExcelWriteUtility.writeResults2s("s2s_Result", emailId,ExpectedStatus,status, comment, purchaseId,PSP);
            driver.quit();
            return; 
        } else {
	...
	public void s2sMethod(String ExpectedStatus,String PSP) throws Exception {
        ...
        if (flag.equalsIgnoreCase("false")) {
            ...
            ExcelWriteUtility.writeResults2s("s2s_Result", emailId,ExpectedStatus, actualOutcome, comment, purchaseId,PSP);
            driver.quit();
            return;
        }
