...
public class email extends baseClass {
	...
	public void Purchase(String Email, String CardHolder, String CardNumber, 
            String Expiry, String CVV, String RunFlag, 
            String ExpectedStatus, String PSP) throws InterruptedException {
...
if (response.statusCode() == 202) {
    ...
    ExcelWriteUtility.writeResult("PurchaseEmail_Result", Email, ExpectedStatus, "FAIL", comment, purchaseId,PSP);
    return; 
} else {
...
try {
    if (response.statusCode() == 202 && checkoutUrl != null && !checkoutUrl.isEmpty()) {
        ...
        if (flag.equalsIgnoreCase("false")) {
            ...
            Reporter.log(comment, true);
            ExcelWriteUtility.writeResult("PurchaseEmail_Result", Email, ExpectedStatus, actualOutcome, comment, purchaseId,PSP);
            return;
